...
export const DICT = {
  en: {
    ...
    'progress.GRAPH': 'Building the graph', 'progress.cancel': 'Cancel and start over', 'progress.partial': 'Results so far',
  ...
  'zh-TW': {
    ...
    'progress.GRAPH': '建立關係圖', 'progress.cancel': '放棄此案，重新開始', 'progress.partial': '目前已完成的成果',
